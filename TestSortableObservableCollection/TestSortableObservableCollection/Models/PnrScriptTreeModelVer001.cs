            ...
            try
            {
                ...
                if (nodeParsedCorrectly)
                {
                    ...
                    else if (classType.Contains("PnrScriptViewModel"))
                    {
                        if (intLevel == 0)
                        {
                            newItem = new PnrScriptViewModel(Constants.WindowMode.View, null, description, null, gdsCmds, null);
                            vm.Root.Add(newItem);
                        }
                        else
                        {
                            ...
                            if (parent != null)
                            {
                                newItem = new PnrScriptViewModel(Constants.WindowMode.View, parent, description, null, gdsCmds, null);
                                parent.AddChildItem(newItem);
                            }
                        }
                        if (newItem != null)
